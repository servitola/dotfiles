...
apps_list = {
    { modifier="caps_lock", chords={
        ...
        {supported=true, key="y", app_name="Firefox" },
...
apps_list2 = {
    {key="\\"},
    {key="1", caps_lock="f1", alt="¹", shift="!", cmd={inner_function="Show Main Panel"}},
    {key="2", caps_lock="f2", alt="²", shift="@"},
    {key="3", caps_lock="f3", alt="³", shift="#"},
    {key="4", caps_lock="f4", alt="$", shift="$"},
    {key="5", caps_lock="f5", alt="‰", shift="%"},
    {key="6", caps_lock="f6", alt="↑", shift="^"},
    {key="7", caps_lock="f7", shift="&"},
    {key="8", caps_lock="f8", alt="∞", shift="*"},
    {key="9", caps_lock="f9", alt="←", shift="("},
    {key="0", caps_lock="f10", alt="→", shift=")"},
    {key="-", alt="—", shift="_"},
    {key="=", alt="≠", shift="+"},
    {key="backspace", alt={ mac="remove_a_word_back"}, fn="delete"},
    {key="tab", cmd={inner_function="switch application"}, ctrl={inner_function="switch_tab"}, ctrl_shift={inner_function="switch_tab_back"}, shift={inner_function="back"}},
    {key="q", caps_lock="page_up", cmd={ inner_function="close_app", taps="2"}, shift="Q"},
    {key="w", caps_lock="up", alt="✓", cmd={ inner_function="close_tab"}, shift="W"},
    {key="e", caps_lock="page_down", alt="€", shift="E"},
    {key="r", caps_lock={ app_name="Rider"}, alt="®", cmd={ inner_function="replace"}},
    {key="t", caps_lock={ app_name="Telegram"}},
    {key="y", caps_lock={ app_name="Chrome"}, alt="ѣ"},
