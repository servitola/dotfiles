...
void servitola(led_t *currentKeyLedColors) {

  // for (int i = 0; i < NUM_ROW * NUM_COLUMN; i++) {
  //   if (servitola_animatedPressedBuf[i] > 5) {
  //     servitola_animatedPressedBuf[i] -= 5;
  //     hsv2rgb(100 - servitola_animatedPressedBuf[i], 255, 225, &ledColors[i]);
  //   } else if (servitola_animatedPressedBuf[i] > 0) {
  //     // ledColors[i].p.blue = 0;
  //     // ledColors[i].p.red = 0;
  //     // ledColors[i].p.green = 0;
  //     servitola_animatedPressedBuf[i] = 0;
  // }
  // }
  ...
  currentKeyLedColors[4].rgb = servitola_colorPalette[1];
  currentKeyLedColors[5].rgb = servitola_colorPalette[1];
  currentKeyLedColors[6].rgb = servitola_colorPalette[1];
  currentKeyLedColors[7].rgb = servitola_colorPalette[1];
  currentKeyLedColors[8].rgb = servitola_colorPalette[1];
  currentKeyLedColors[9].rgb = servitola_colorPalette[1];
  ...
  currentKeyLedColors[23].rgb = servitola_colorPalette[0]; // Up
  currentKeyLedColors[24].rgb = servitola_colorPalette[1];
  currentKeyLedColors[25].rgb = servitola_colorPalette[1];
  currentKeyLedColors[26].rgb = servitola_colorPalette[1];
  currentKeyLedColors[27].rgb = servitola_colorPalette[1];

  currentKeyLedColors[28].rgb = servitola_colorPalette[1]; // FN1
  currentKeyLedColors[29].rgb = servitola_colorPalette[0]; // Left
  currentKeyLedColors[30].rgb = servitola_colorPalette[0]; // Down
  currentKeyLedColors[31].rgb = servitola_colorPalette[0]; // Right
  currentKeyLedColors[32].rgb = servitola_colorPalette[1];
  currentKeyLedColors[33].rgb = servitola_colorPalette[1];
  currentKeyLedColors[34].rgb = servitola_colorPalette[1];
  currentKeyLedColors[35].rgb = servitola_colorPalette[1];
  currentKeyLedColors[36].rgb = servitola_colorPalette[0]; // Left
  currentKeyLedColors[37].rgb = servitola_colorPalette[0]; // Down
  currentKeyLedColors[38].rgb = servitola_colorPalette[0]; // Right
  currentKeyLedColors[39].rgb = servitola_colorPalette[1];
  currentKeyLedColors[40].rgb = servitola_colorPalette[1];

  currentKeyLedColors[41].rgb = servitola_colorPalette[1];
  currentKeyLedColors[42].rgb = servitola_colorPalette[1];
  currentKeyLedColors[43].rgb = servitola_colorPalette[1];
  currentKeyLedColors[44].rgb = servitola_colorPalette[1];
  currentKeyLedColors[45].rgb = servitola_colorPalette[1];
  currentKeyLedColors[46].rgb = servitola_colorPalette[1];
  currentKeyLedColors[47].rgb = servitola_colorPalette[1];
  currentKeyLedColors[48].rgb = servitola_colorPalette[1];
  currentKeyLedColors[49].rgb = servitola_colorPalette[1];
  currentKeyLedColors[50].rgb = servitola_colorPalette[1];
  currentKeyLedColors[51].rgb = servitola_colorPalette[1];
  currentKeyLedColors[52].rgb = servitola_colorPalette[1];
  ...
  currentKeyLedColors[62].rgb = servitola_colorPalette[1];
...
void servitola_reactiveFadeKeypress(led_t *currentKeyLedColors, uint8_t row, uint8_t col) {
   ...
   if(i == 28 && false)
   {
      ...
      currentKeyLedColors[0].rgb = servitola_colorPalette[5]; // Esc
  currentKeyLedColors[2].rgb = servitola_colorPalette[5];
  currentKeyLedColors[1].rgb = servitola_colorPalette[5];
  currentKeyLedColors[3].rgb = servitola_colorPalette[5];
  currentKeyLedColors[4].rgb = servitola_colorPalette[5];
  currentKeyLedColors[5].rgb = servitola_colorPalette[5];
  currentKeyLedColors[6].rgb = servitola_colorPalette[5];
  currentKeyLedColors[7].rgb = servitola_colorPalette[5];
  currentKeyLedColors[8].rgb = servitola_colorPalette[5];
  currentKeyLedColors[9].rgb = servitola_colorPalette[5];
  currentKeyLedColors[10].rgb = servitola_colorPalette[5];
  currentKeyLedColors[11].rgb = servitola_colorPalette[5];
  currentKeyLedColors[12].rgb = servitola_colorPalette[5];
  currentKeyLedColors[13].rgb = servitola_colorPalette[5];

  currentKeyLedColors[14].rgb = servitola_colorPalette[5];
  ...
  currentKeyLedColors[23].rgb = servitola_colorPalette[6]; // Up
  currentKeyLedColors[24].rgb = servitola_colorPalette[5];
  currentKeyLedColors[25].rgb = servitola_colorPalette[5];
  currentKeyLedColors[26].rgb = servitola_colorPalette[5];
  currentKeyLedColors[27].rgb = servitola_colorPalette[5];

  currentKeyLedColors[28].rgb = servitola_colorPalette[5]; // FN1
  currentKeyLedColors[29].rgb = servitola_colorPalette[6]; // Left
  currentKeyLedColors[30].rgb = servitola_colorPalette[6]; // Down
  currentKeyLedColors[31].rgb = servitola_colorPalette[6]; // Right
  currentKeyLedColors[32].rgb = servitola_colorPalette[5];
  currentKeyLedColors[33].rgb = servitola_colorPalette[5];
  currentKeyLedColors[34].rgb = servitola_colorPalette[5];
  currentKeyLedColors[35].rgb = servitola_colorPalette[5];
  currentKeyLedColors[36].rgb = servitola_colorPalette[6]; // Left
  currentKeyLedColors[37].rgb = servitola_colorPalette[6]; // Down
  currentKeyLedColors[38].rgb = servitola_colorPalette[6]; // Right
  currentKeyLedColors[39].rgb = servitola_colorPalette[5];
  currentKeyLedColors[40].rgb = servitola_colorPalette[5];

  currentKeyLedColors[41].rgb = servitola_colorPalette[5];
  currentKeyLedColors[42].rgb = servitola_colorPalette[5];
  currentKeyLedColors[43].rgb = servitola_colorPalette[5];
  currentKeyLedColors[44].rgb = servitola_colorPalette[5];
  currentKeyLedColors[45].rgb = servitola_colorPalette[5];
  currentKeyLedColors[46].rgb = servitola_colorPalette[5];
  currentKeyLedColors[47].rgb = servitola_colorPalette[5];
  currentKeyLedColors[48].rgb = servitola_colorPalette[5];
  currentKeyLedColors[49].rgb = servitola_colorPalette[5];
  currentKeyLedColors[50].rgb = servitola_colorPalette[5];
  currentKeyLedColors[51].rgb = servitola_colorPalette[5];
  currentKeyLedColors[52].rgb = servitola_colorPalette[5];
  currentKeyLedColors[53].rgb = servitola_colorPalette[5];
  currentKeyLedColors[54].rgb = servitola_colorPalette[5];

  currentKeyLedColors[55].rgb = servitola_colorPalette[5];
  currentKeyLedColors[56].rgb = servitola_colorPalette[5];
  currentKeyLedColors[57].rgb = servitola_colorPalette[5];
  currentKeyLedColors[58].rgb = servitola_colorPalette[5];
  currentKeyLedColors[59].rgb = servitola_colorPalette[5];
  currentKeyLedColors[60].rgb = servitola_colorPalette[5];
  currentKeyLedColors[61].rgb = servitola_colorPalette[5];
  currentKeyLedColors[62].rgb = servitola_colorPalette[5];
  currentKeyLedColors[63].rgb = servitola_colorPalette[5];
  currentKeyLedColors[64].rgb = servitola_colorPalette[5];
  currentKeyLedColors[65].rgb = servitola_colorPalette[5];
  currentKeyLedColors[66].rgb = servitola_colorPalette[5];
  currentKeyLedColors[67].rgb = servitola_colorPalette[5];
  currentKeyLedColors[68].rgb = servitola_colorPalette[5];
   }
   else
   {
