...
Use this skill when the user asks for high-quality design work to be produced as local artifacts, in a CLI/API environment rather than a hosted design web UI.
...
There are three design-related skills in this library. They do different jobs — load the right one (or combine them):
