# Generated by Powerlevel10k configuration wizard on 2022-09-24 at 01:16 EEST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.sh, checksum 15312.
...
() {
  ...
  # restarting zsh. Edit ~/.p10k.sh and type `source ~/.p10k.sh`.
  ...
  # https://github.com/romkatv/gitstatus/blob/master/gitstatus.plugin.sh.
