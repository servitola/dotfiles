...
- [Simulating Reviews Before Submission](#simulating-reviews-before-submission)
- [Prioritizing and Acting on Feedback](#prioritizing-and-acting-on-feedback)
- [How to Address Reviewer Feedback](#how-to-address-reviewer-feedback)
- [Rebuttal Writing](#rebuttal-writing)
...
## Simulating Reviews Before Submission

Simulate the review process before submission to catch weaknesses early.

### Ensemble Review Pattern
...
| Priority | Action |
|----------|--------|
| **Critical** (technical flaw, missing baseline) | Must fix. May require new experiments → back to experiment design |
...
- Use `latexdiff` to generate a marked-up PDF showing changes (see [latex-toolkit.md](latex-toolkit.md))
