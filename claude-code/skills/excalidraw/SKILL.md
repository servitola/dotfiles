...
name: excalidraw
description: |
  Generate hand-drawn-style Excalidraw JSON diagrams (architecture, flowcharts, sequence) as .excalidraw files.

  Use when: "нарисуй диаграмму в excalidraw", "сделай схему архитектуры", "draw an excalidraw diagram", "make a flowchart"
---
...
Saving diagrams needs nothing beyond writing a JSON file. Uploading for a shareable link requires Python with the `cryptography` package:
...
Run the upload script (located in this skill's `scripts/` directory):
