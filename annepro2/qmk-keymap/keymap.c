...
* \----------------------------------------------------------------------------------------*/
  ...
  * Layer _FN2_LAYER
  * ,---------------------------------------------------------------------------------------------------.
  * |  ~  | SWAP | UNSWAP | LENON | LEFOF | LED_INT| LED_SPEED | F7 |F8| F9 | BT1 | BT2 | BT3 |   Bksp  |
  * |---------------------------------------------------------------------------------------------------+
 ...
 [_FN2_LAYER] = KEYMAP( /* Base */
    KC_TRNS, KC_TRNS, MAGIC_UNSWAP_LALT_LGUI, KC_AP_LED_ON, KC_AP_LED_OFF, KC_AP_LED_NEXT_INTENSITY, KC_AP_LED_SPEED, KC_TRNS, KC_TRNS, KC_TRNS, KC_AP2_BT1, KC_AP2_BT2, KC_AP2_BT3, KC_TRNS,
