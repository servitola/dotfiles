...
description: |
  54 real-world design systems (Stripe, Linear, Vercel, Apple...) as ready-to-use HTML/CSS tokens and component specs.

  Use when: "сделай страницу как у Stripe", "дизайн в стиле Linear", "build a page that looks like Vercel", "landing page styled like Apple"
---
...
2. Load it: `Read` the file `templates/<site>.md`
3. Use the design tokens and component specs when generating HTML
4. Write the result with `Write`, then open it in a browser to verify
...
Write the file with `Write`, then open it in a browser to confirm visual accuracy.
