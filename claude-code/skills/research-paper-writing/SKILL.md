...
The citation-verification and analysis steps use Python packages and a LaTeX toolchain:
...
This skill drives the full research lifecycle. Map each phase onto the tools available in your harness.
