# Generated by Powerlevel10k configuration wizard on 2024-08-15 at 23:09 EEST.
...
# angled separators, flat heads, sharp tails, 2 lines, disconnected, left frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%214F┏━'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%214F┣━'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%214F┗━'
